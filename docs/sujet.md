...
travail Ã  2 ou 3 personnes.
Environnement un peu dÃ©gradÃ© (pas de maquette Figma) => Demo avec Figma

### Stack technique

- HTML + SCSS (sass) pas de framework CSS (bootstrap c'est ciao)
- Git pour le versionning
- Github pour travailler en Ã©quipe
- PAS DE JAVASCRIPT !!!
...
- GÃ©rer les espacements avec des multiples de 8px